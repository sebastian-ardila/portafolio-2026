...
export const experience: IExperience[] = [
  {
    id: 'rmp-director',
    company: 'RunMyProcess (AK digital LLC)',
  ...
  },
  {
    ...
    description:
      'Developed a cryptocurrency payment and investment management system with a dynamic React.js frontend. Led a team of two developers and a UX designer. Migrated the project to Remix.js and implemented GraphQL to unify the API schema. Managed MongoDB for large volumes of transactional data.',
    technologies: ['React', 'Remix.js', 'GraphQL', 'Node.js', 'MongoDB'],
  },
  {
    id: 'td7',
    company: 'Tecnología Digital 7',
    role: 'Backend Web Developer',
    period: 'Jan 2018 - Aug 2018',
    description:
      'Developed a real-time cryptocurrency price visualization application using Socket.io. Built backend services with Express.js and MongoDB. Spearheaded the development of a cryptocurrency wallet and ICO platform based on Ethereum.',
    technologies: ['Socket.io', 'Express.js', 'MongoDB', 'Ethereum', 'Mocha.js'],
  },
  {
    id: 'onyxsoft',
    company: 'Onyx Soft SAS',
